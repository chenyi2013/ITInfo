...
public class ScrollIndexScroller {
	...
	public ScrollIndexScroller(Context context, LinearLayout ll) {
		...
		if (mSections != null && mSections.length > 0) {
			...
			if (mCurrentSection >= 0) {
				...
				RectF previewRect = new RectF(
						(mLinearLayoutWidth - previewSize) / 2,
						(mLinearLayoutHeight - previewSize) / 2,
						(mLinearLayoutWidth - previewSize) / 2 + previewSize,
						(mLinearLayoutHeight - previewSize) / 2 + previewSize);
	...
	public void onSizeChanged(int w, int h, int oldw, int oldh) {
		mLinearLayoutWidth = w;
		mLinearLayoutHeight = h;
